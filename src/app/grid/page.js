export default function Home() {
    return (
      <main>
        <section id="skills-section" className="bg-cyan-300 w-screen h-screen grid grid-cols-1 lg:grid-cols-2 grid-rows-7 lg:grid-rows-10 gap-4 p-4">
          <div className="row-span-3 lg:row-span-6 col-span-1 lg:col-span-1">
          ...
          <div className="row-span-4 col-span-1 lg:col-span-2">
