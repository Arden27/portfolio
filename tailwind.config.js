...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        clamp_greating: "clamp(0.5rem, 2vw + 1px, 5rem)",
        clamp_name: "clamp(1rem, 3vw + 1px, 5rem)",
        clamp_profession: "clamp(0.8rem, 2vw + 1px, 5rem)",
        clamp_description: "clamp(0.5rem, 1.5vw + 1px, 1.5rem)",
        clamp_sm_section_name: "clamp(0.5rem, 5.5vh + 1px, 2.5rem)",
        clamp_section_name: "clamp(0.5rem, 3.7vh + 1px, 2.5rem)",
