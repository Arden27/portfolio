...
const BackendSkills = () => {
    return (
        <div 
            ...
            id="backend-skills"
        >
            <h2 className="max-sm:text-clamp_sm_skills_category_name border rounded-xl p-1 border-primary bg-gray-100/50 md:mb-2 text-center text-gray-700 text-xl">Backend</h2>
