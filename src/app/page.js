...
export default function Small() {
    ...
    return (
        ...
        >
            ...
            >
                <div className="flex md:gap-10 drop-shadow-xl max-sm:pt-12 max-sm:pb-2 w-full h-full flex-col items-center justify-center md:h-screen md:flex-row">
                    ...
                    <div className="max-sm:text-[10svh] max-sm:flex max-sm:h-1/2 md:w-1/3 max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:p-4">
                        ...
                        <h3 className="text-[50%] leading-[1.2] drop-shadow-lg md:leading-[1.1] md:text-clamp_name font-bold">
                            Artem Furman
                        </h3>
                        ...
                        <a
                            ...
                            className="max-sm:text-[30%] md:text-xl drop-shadow-xl inline-block cursor-pointer rounded-lg bg-orange-600 px-5 py-2 font-medium text-white transition-all duration-200 ease-in-out border border-transparent hover:border hover:border-orange-600 hover:bg-white hover:text-orange-600"
                        >
                            Portfolio
                        </a>
                    </div>
