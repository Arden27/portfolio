...
const FrontendSkills = () => {
    return (
        <div 
            ...
            id="frontend-skills"
        >
            <h2 className="max-sm:text-clamp_sm_skills_category_name border rounded-xl p-1 bg-gray-100/50 border-primary md:mb-2 text-center text-gray-700 text-xl">Frontend</h2>
